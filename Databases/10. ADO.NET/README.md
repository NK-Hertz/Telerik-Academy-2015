...
1.  *Not Finished* Write a program that retrieves the images for all categories in the `Northwind` database and stores them as JPG files in the file system.
1.  *Not Finished* Create an Excel file with 2 columns: `name` and `score`:
...
1.  *Not Finished*Implement appending new rows to the Excel file.
